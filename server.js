...
const HTML_DIR = path.join(__dirname, "../whatsapp-boosmap/public");
const JSON_FILE_PATH = path.join(__dirname, "../whatsapp-boosmap/archivo.json");
...
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, "/../whatsapp-boosmap/public/index.html"));
});
...
client.on("qr", (qr) => {
  QRCode.toFile(
    path.join(__dirname, "/../whatsapp-boosmap/public/code.png"),
    qr,
    {
