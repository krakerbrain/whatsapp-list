...
const HTML_DIR = path.join(__dirname, "../whatsapp-list/public");
const JSON_FILE_PATH = path.join(__dirname, "../whatsapp-list/archivo.json");
...
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, "/../whatsapp-list/public/index.html"));
});
...
client.on("qr", (qr) => {
  QRCode.toFile(
    path.join(__dirname, "/../whatsapp-list/public/code.png"),
    qr,
    {
